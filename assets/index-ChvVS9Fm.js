...
const rt = V("Zap", [
	...
	Fb = () => {
		const [e, t] = k.useState(null), {
			...
			answer: "B×R is the best free and safest hub for finding games! B×R is the best free and safest hub for finding games! Join our Discord community for instant support, updates, and to connect with other users. Our team is active and ready to help!"
		}], s = o => {
			t(e === o ? null : o)
		};
		return a.jsxs("section", {
					...
					children: [a.jsxs("div", {
						...
						children: [a.jsx("div", {
							...
							children: a.jsxs("div", {
								...
								}), n === "vietnam" && (h == null ? void 0 : h.status) === "Released" && a.jsx("div", {
									className: `mb-8 p-6 bg-orange-500/10 border border-orange-500/30 rounded-2xl transition-all duration-300 ${o?"opacity-0 scale-95":"opacity-100 scale-100"}`,
									children: a.jsxs("div", {
										...
										children: [a.jsx("div", {
											...
											children: [a.jsx("h4", {
												...
												children: "Regional Warning"
											}), a.jsx("p", {
												className: "text-orange-200 text-sm leading-relaxed",
												children: '"Roblox VNG" is intended for Vietnam residents only. Downloading this version may permanently change your account localization, limiting access to the global version of Roblox.'
											})]
										})]
									})
								}), a.jsxs("button", {
